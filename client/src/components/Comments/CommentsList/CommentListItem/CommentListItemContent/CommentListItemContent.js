...
class CommentListItemContent extends Component {
  ...
  render() {
    const { comment, canModify, classes } = this.props;
...
export default withStyles(styles)(ToJs(CommentListItemContent));
